...
@Service("UnSubscribeChannelHandler")
@AllArgsConstructor
public class UnSubscribeChannelHandler implements IHandler<ChannelMessage> {
    ...
    public void Handle(ChannelMessage messageObject, Session session) {
        ...
        serverManager.unsubscribeClientToChannel(client, Integer.parseInt(messageObject.getChannel_id()));
    }
}